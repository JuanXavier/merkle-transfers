...
// function hashToken(account: any, amount: any) {
//   return Buffer.from(ethers.utils.solidityPack(["address", "uint256"], [account, amount]).slice(2), "hex");
// }

// describe("mk", function () {
//   it("Should verify a valid proof", async function () {
//     this.merkleTree = new MerkleTree(
//       Object.entries(data).map(([account, amount]) => hashToken(account, amount)),
//       keccak256,
//       { sortPairs: true }
//     );
